...
function ensureEvaluationsSchema(mysqli $conn): void
{
    $conn->query("
        CREATE TABLE IF NOT EXISTS evaluations (
            ...
            UNIQUE KEY uniq_student_faculty_subject_class (student_id, faculty_id, subject_id, class_id),
    ...
    addEvaluationIndexIfMissing($conn, 'uniq_student_faculty_subject_class', "ALTER TABLE evaluations ADD UNIQUE KEY uniq_student_faculty_subject_class (student_id, faculty_id, subject_id, class_id)");
}
